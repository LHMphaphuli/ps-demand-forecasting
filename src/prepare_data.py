...
def prepare_ted_half_hourly_forecast(file_path, days=1):
    """
    Function to get half-hourly electric demand forecast for each gas day with the option to 
    shift data by days.
    ...
    Returns:
        demand_forecast (pandas DataFrame): Wrangled dataframe with forecasted demand 
        data.
        For example if days=1, then the data for GAS_DAY 20-01-2022 is the predicted 
        demand for 19-01-2022 and they
